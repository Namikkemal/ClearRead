...
// Brand colors
val ClearBlue = Color(0xFF2196F3)
val ClearBlueDark = Color(0xFF1976D2)
val ClearBlueLight = Color(0xFF64B5F6)
...
// Dark theme — true dark as specified (#121212)
...
val DarkBackground = Color(0xFF121212) // True dark per spec
val DarkOnBackground = Color(0xFFE3E2E6)
val DarkSurface = Color(0xFF121212) // True dark per spec
...
// Night mode reader tint (warm amber for eye strain reduction)
val NightModeAmber = Color(0xFFFFC107)
val NightModeAmberDim = Color(0x33FFC107)
val NightModeSurface = Color(0xFF1A1400)
